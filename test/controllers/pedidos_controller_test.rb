...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { id_cardapio: @pedido.id_cardapio, id_cliente: @pedido.id_cliente } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { id_cardapio: @pedido.id_cardapio, id_cliente: @pedido.id_cliente } }
